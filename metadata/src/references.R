...
#' author: "<strong>Updated:</strong>"
#' date: '`r strftime(Sys.time(), "%F at %T")`'
#' output: github_document
#' ---
#'
#' BibTeX citations are stored in [references.bib](../references.bib).
#' This file was generated by [references.R](references.R).
